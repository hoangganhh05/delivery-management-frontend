...
export function Footer() {
  return (
    <footer className="relative z-10 mt-20 border-t border-white/10 bg-neutral-950 text-neutral-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-950/60 border border-emerald-500/30 text-emerald-300 text-[11px] font-semibold">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center gap-2 text-neutral-300">
                ...
                <span className="font-bold text-white">1900 8095</span> (24/7 Miễn phí)
              </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-neutral-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <span>•</span>
            <span className="hover:text-white cursor-pointer transition-colors">Quy chế bồi thường</span>
          </div>
        </div>
      </div>
    </footer>
